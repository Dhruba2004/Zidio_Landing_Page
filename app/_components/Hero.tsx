...
function Hero() {
  ...
  <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
    <div className="flex flex-col gap-5 relative md:bottom-[2rem]">
      <h2 className="pointer-events-none whitespace-pre-wrap text-3xl md:text-4xl lg:text-left mt-10 md:mt-[6rem] text-violet-700 dark:text-[#fff] font-semibold bg-gradient-to-b from-black to-gray-300/80 bg-clip-text">
      ...
      <div className="flex gap-3">
        <ShimmerButton className="dark:text-white cursor-pointer">Let's Talk</ShimmerButton>
        <ShimmerButton className="dark:text-white cursor-pointer">Read More</ShimmerButton>
      </div>
      <div className="flex gap-4 items-center ml-4">
        <Link className="cursor-pointer" href={'https://www.facebook.com/people/Zidio-Development/61556709391417/'}>
        ...
        <Link className="cursor-pointer" href={'https://www.linkedin.com/company/zidio-development/mycompany/verification/'}>
